					...
					<table class="table table-striped">
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control"
								name="subject" value="<%=bean.getSubject()%>"></td>
						</tr>
						...
						<tr>
							...
							<td colspan="3"><textarea name="content"
									class="form-control"><%=bean.getContent()%></textarea></td>
						</tr>

						<tr>
							<td colspan="4" class="text-center"><input type="hidden"
								name="num" value="<%=bean.getNum()%>"> <input
								type="submit" value="글수정" class="btn btn-warning"> <input
