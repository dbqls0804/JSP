...
<body>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<h2 class="text-center">답변글 입력하기</h2>
			<p></p>
					...
					<table class="table table-striped">
						...
						<tr>
							<td colspan="2" class="text-center"><input type="hidden"
								...
								name="ref" value="<%=ref%>"> <input type="hidden"
								name="re_step" value="<%=re_step%>"> <input
								type="hidden" name="re_level" value="<%=re_level%>"> <input
								type="submit" value="답글쓰기완료" class="btn btn-success"> <input
								type="reset" value="취소" class="btn btn-warning"> <input
